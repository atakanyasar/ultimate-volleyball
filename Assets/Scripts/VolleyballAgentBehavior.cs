...
public class VolleyballAgentBehavior : Agent
{
    ...
    VolleyballAgent volleyballAgent;
    ...
    void Start()
    {
        ...
        volleyballAgent = GetComponentInParent<VolleyballAgent>();
    }
    ...
    void OnCollisionEnter(Collision c)
    {
        ...
        {
            envController.UpdateLastHitter(teamId, volleyballAgent);
        }
    }
    ...
    {
        var previousDistance = Vector3.Distance(this.transform.position, volleyballAgent.ManagerTarget);
    ...
    public void CollectTargetObservations(VectorSensor sensor)
    {
        Vector3 toTarget = new Vector3(
            (volleyballAgent.ManagerTarget.x - this.transform.position.x)*agentRot,
            (volleyballAgent.ManagerTarget.y - this.transform.position.y),
            (volleyballAgent.ManagerTarget.z - this.transform.position.z)*agentRot
        );
